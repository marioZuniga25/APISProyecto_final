...
namespace ProyectoFinalAPI.Controllers
{
 ...
 public class RecetaController : ControllerBase
 {
        ...
        public RecetaController(ProyectoContext context, ILogger<RecetaController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<ActionResult<IEnumerable<Receta>>> GetListadoRecetas()
        {
            ...
            {
                _logger.LogError($"Error al obtener el listado de recetas: {ex.Message}");
        ...
        public async Task<ActionResult<Receta>> GetRecetaById(int id)
        {
            ...
            {
                _logger.LogError($"Error al obtener la receta con ID {id}: {ex.Message}");
                return StatusCode(500, "Error interno del servidor");
            }
        }
        ...
        public async Task<ActionResult> AgregarReceta([FromBody] RecetaDto request)
        {
            ...
            {
                _logger.LogError($"Error al agregar la receta: {ex.Message}");
                return StatusCode(500, "Error interno del servidor");
            }
        }
        ...
        public async Task<ActionResult> ModificarReceta(int id, [FromBody] RecetaDto request)
        {
            ...
            {
                _logger.LogError($"Error al modificar la receta con ID {id}: {ex.Message}");
                return StatusCode(500, "Error interno del servidor");
            }
        }
        ...
        public async Task<ActionResult> EliminarReceta(int id)
        {
            ...
            {
                _logger.LogError($"Error al eliminar la receta con ID {id}: {ex.Message}");
                return StatusCode(500, "Error interno del servidor");
            }
        }
        ...
        public async Task<ActionResult> ProcesarReceta(int id, int cantidad)
        {
            ...
            {
                _logger.LogError($"Error al procesar la receta con ID {id}: {ex.Message}");
                return StatusCode(500, "Error interno del servidor");
            }
        }
    }
